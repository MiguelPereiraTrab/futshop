...
import './PremierLeagueRetro.css'; // Importando o arquivo CSS


class PremierLeagueRetro extends Component {
  render() {
    const imageList = [
    ...
    return (
      <div className="PremierLeagueRetro">
        <Header />
...
export default PremierLeagueRetro;
